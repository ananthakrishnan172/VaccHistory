<?php 
	...
	$per_page = 20;
		...
		$count = $db->query("SELECT * FROM vaccinedetails");
		...
		$cat = $db->query("SELECT * FROM vaccinedetails LIMIT $start, $per_page");
		...
		if($cat->num_rows) {
			...
			while($row = $cat->fetch_assoc()) {
				...
				$result .=  "<tr>
								...
								<td><a href='vaccineslist.php?delete=".$vaccid."' onclick='return check();'><i class='pe-7s-close-circle'></i></a></td>
							</tr>";
	...
	if(isset($_GET['delete'])) {
		...
		if($delete != "") {
			...
			$sql = $db->query("DELETE FROM vaccinedetails WHERE vaccid='".$delete."'");
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #000;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">Vaccines</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='vaccineslist.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #FF5722;' >$i</a>  "  : " <a href='vaccineslist.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
