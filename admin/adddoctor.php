...
{   $dr="Dr.";
    ...
    $insertquery="INSERT INTO doctordetails(name,gender,email,password,hospital,state,district,area,phno,pincode)
    VALUES ('$name','$gender','$email','$password','$hospital','$state','$district','$area','$phno','$pincode');";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #000;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ADD DOCTOR PROFILES</a>
                </div>
...
<form action="" method="post">
  ...
  <div class="form-group col-md-4">
      <label for="inputZip">Area</label>
      <input type="text" name="area" class="form-control" id="inputZip">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="phno" name="phno" class="form-control" id="inputEmail4" placeholder="Phone No.">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">PINCODE</label>
      <input type="pincode" name="pincode" class="form-control" id="inputPassword4" placeholder="PINCODE">
    </div>
  </div>
