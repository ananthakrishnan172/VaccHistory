    ...
    if(isset($_POST['submit'])) 
{
    ...
    $insertquery="INSERT INTO hospitaldetails(name,state,district,landmark) VALUES ('$name','$state','$district','$landmark');";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #000;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ADD HOSPITAL</a>
                </div>
...
<form action="" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="landmark" class="form-control" id="inputAddress" placeholder="Enter the hospital address">
  </div>
